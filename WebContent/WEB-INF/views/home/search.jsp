...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2020, 思洁入梦, GT." />
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12" style="color:#787878">
        友情链接:
        <a href="http://programmer.ischoolbar.com/">猿来入此</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-1 col-xs-0"></div>
      <div class="col-md-9 col-xs-12">
        <p style="color:#787878">Copyright 2018 - 2019 
        	<a href="http://programmer.ischoolbar.com/">猿来入此出品</a>|
        	<a href="/RubbishCategory/system/login" target="_blank">登录后台</a>
        </p>
      </div>
    </div>
  </div>
